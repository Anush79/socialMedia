      ...
      <div className="leftUpper">
        <div className="feed clickableIcon">
          <NavLink to="/home/feed">
            <DynamicFeedIcon />
            <span className="hideInMobile clickableIcon">Feed</span>
          </NavLink>
        </div>
        <div className="search clickableIcon">
          <NavLink to="/home/search">
            <PersonSearchOutlinedIcon />
            <span className="hideInMobile clickableIcon">Search</span>
          </NavLink>
        </div>
        <div className="explore clickableIcon">
          <NavLink to="/home/explore">
            {" "}
            <ExploreOutlinedIcon />
            <span className="hideInMobile clickableIcon">Explore</span>
          </NavLink>
        </div>
        <div className="bookMarks clickableIcon">
          <NavLink to="/home/bookmarks">
            <BookmarksOutlinedIcon />
            <span className="hideInMobile clickableIcon">Bookmarks</span>
          </NavLink>
        </div>
        <div
        ...
        >
          <NavLink
            to={`/home/profile/${currentUser.username}/${currentUser._id}`}
          >
            <AccountBoxOutlinedIcon />
            <span className="hideInMobile clickableIcon">Profile</span>
          </NavLink>
        </div>
      </div>
