...
export const bookmarkPostHandler = function (schema, request) {
  ...
  try {
    ...
    user.bookmarks.push({ _id:post._id, username: post.username,likes:post.likes,mediaURL:post.mediaURL, content: post.content, createdAt: post.createdAt, updatedAt: post.updatedAt });
